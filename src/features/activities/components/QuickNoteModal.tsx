        ...
        <div className="flex items-center justify-between pb-4 border-b border-slate-800">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <span className="text-xs text-indigo-400 font-mono tracking-wide uppercase">
                {activity.category}
              </span>
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit} className="mt-4 space-y-4">
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full rounded-xl bg-slate-950 border border-slate-800 px-3.5 py-2.5 text-sm text-slate-100 placeholder:text-slate-500 focus:outline-none focus:border-indigo-500 transition-colors"
            />
          </div>
          ...
          {activity.is_expense_trigger && (
            <div className="p-3.5 rounded-xl bg-indigo-500/10 border border-indigo-500/30 flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <h4 className="text-sm font-semibold text-indigo-200">Attach Expense?</h4>
